...
def ambil_tabel_dari_situs():
    try:
        url = "http://146.190.92.226/data-keluaran-hongkong/"
...
def gabungkan_ke_template(tabel_html):
    try:
        ...
        with open("result_hk.html", "w", encoding="utf-8") as f:
            f.write(hasil_html)

        print("✅ result_hk.html berhasil dibuat.")
        return hasil_html
...
if __name__ == "__main__":
    ...
    if tabel_html:
        ...
        if full_html:
            with open("result_hk.html", "w", encoding="utf-8") as f:
                f.write(full_html)
            print("✅ File result_hk.html disimpan.")
